...
* [✔️] cd into the project base directory `cd web-module-project-client-auth`
* [✔️] Download project dependencies by running `npm install`
* [✔️] cd into the `server` folder.
* [✔️] Start up the app using `npm start` to start the server.
* [✔️] cd into the `friends` folder.
* [✔️] Run `npm start` to start the client code.
